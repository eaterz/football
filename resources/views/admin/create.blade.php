<x-app-layout>
    <div class="w-full min-h-screen bg-gray-50 flex flex-col items-center pt-6 sm:pt-0">
        ...
        <div class="mt-30 m-20 pb-2 bg-white rounded-lg shadow-lg p-6 w-full sm:max-w-md mx-auto overflow-auto">
            <h2 class="mb-12 text-black text-center text-5xl font-extrabold">Create Product</h2>
            ...
            <form method="POST" action="{{ route('products.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" placeholder="Product Description"
                              class="text-black py-2 resize-none px-3 border border-gray-300 focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm disabled:bg-gray-100 mt-1 block w-full" rows="4"></textarea>
